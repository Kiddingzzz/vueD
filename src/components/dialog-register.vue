      ...
      <a-form class="content" :form="form"  @submit="handleSubmit"> 
        ...
        <a-form-item class="font-size">
          <a-checkbox   
            ...
            <a-modal class="xieyi" title="《商家合作协议》" width="80vw" okText="确认" cancelText="取消" v-model="visible" @ok="handleOk">
              <strong>1、开单王服务条款的接受</strong>
              <p>通过完成开单王注册程序，用户便表明其接受了本服务协议的条款，并同意受本服务协议的约束；同时，用户保证其提交的信息真实、准确、及时和完整。 本服务协议所称的用户是指完全同意所有条款(以下简称“服务条款”)并完成注册程序的服务接受者。</p>
              <strong>2、 服务条款的变更和修改</strong>
              <p>开单王保留依其自主判断在将来的任何时间变更、修改、增加或删除本服务协议条款的权利。所有修改的协议均构成本服务协议的一部分。开单王有权随时对服务条款进行修改，一旦发生服务条款的变动，开单王将提示修改的内容；当用户使用开单王的特殊服务时，应接受开单王随时提供的与该特殊服务相关的规则或说明，并且此规则或说明均构成本服务条款的一部分。用户如果不同意服务条款的修改，可以主动取消已经获得的网络服务；如果用户继续享用网络服务，则视为用户已经接受服务条款的修改。</p>
              ...
              <p>开单王运用自己的操作系统通过国际互联网向用户提供丰富的网上资源，包括各种信息工具，个性化服务等(以下简称本服务)。除非另有明确规定，增强或强化目前服务的任何新功能，包括新产品，均无条件地适用本服务条款。
                ...
                <br/>(2).不断更新注册资料。
                <br/>若用户提供任何错误、不实、过时或不完整的资料，或者开单王有合理理由怀疑前述资料为错误、不实、过时或不完整，开单王有权暂停或终止用户的帐号，并拒绝其现在或将来使用本服务的全部或一部分。 开单王有权规定并修改使用本服务的一般措施，包括但不限于决定保留电子邮件讯息或其他上载内容的时间、限制本服务一个帐号可接收信息的数量等措施。如开单王未能储存或删除本服务的内容或其他讯息，开单王不负担任何责任。对于用户3个月未使用的帐号，开单王有权(但无义务)予以删除。
              ...
              <p>用户同意遵守中华人民共和国法律法规，尤其是《中华人民共和国保守国家秘密法》、《中华人民共和国计算机信息系统安全保护条例》、《计算机软件保护条例》等有关计算机及互联网的法律法规和实施办法。在任何情况下，如果开单王有 合理理由认为用户的行为可能违反上述法律、法规，开单王可以在任何时候，不经事先通知终止向该用户提供服务。用户应了解国际互联网的无国界性，应特别注意遵守当地所有有关的法律和法规。</p>
              ...
              <p>开单王有权在任何时候，暂时或永久地修改或终止本服务或其中任何一部分，无论是否通知。开单王对本服务的修改或终止对用户和任何第三人不承担任何责任。开单王有权基于任何理由，终止用户的帐号、密码或拒绝其使用本服务，或删除、转移用户存储、发布在本服务的内容，开单王采取上述行为均不需通知，并且对用户和任何第三人不承担任何责任。</p>
              <strong>11、 通知</strong>
              ...
              <p>本服务条款的生效、履行、解释及争议的解决均适用中华人民共和国法律，发生的争议提交厦门仲裁委员会，其仲裁裁决是终局的。如果本服务协议中某项条款因与中华人民共和国现行法律相抵触而导致无效，将不影响其他部分的效力。</p>
