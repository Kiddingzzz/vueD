    ...
    <div class="dialog" v-show="showMask">
        <div class="dialog-container">
            ...
            <div class="content">
                <div>
                    <label>会员名称:</label>
                    <input type="text" class="inputs" placeholder="请输入5-25个字符组成的会员名，推荐使用中文" v-model="userName">
                </div>
                <div>
                    <label>登录密码:</label>
                    <input type="password" class="inputs" placeholder="请输入6-20个由大小字母、数字、标点组成的密码" v-model="password">
                </div>
                <div>
                    <label>确认密码:</label>
...
<script>
    export default {
        ...
        methods: {
            ...
            async doregister() {
                if (this.password.length < 6 && this.respassword.length<6) {
